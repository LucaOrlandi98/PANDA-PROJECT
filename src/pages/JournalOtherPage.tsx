...
export function JournalOtherPage() {
  const visibleOtherNav = journalOtherNav.filter((item) =>
    isSectionVisible(
      item.id === "attrezzatura"
  ...
  return (
    <div className="page-stack journal-page journal-other-page">
      ...
      {isSectionVisible("journal.other.nav") && visibleOtherNav.length > 0 ? (
      ...
      {isSectionVisible("journal.other.equipment") ? (
        <section
      ...
      {isSectionVisible("journal.other.mechanical") ? (
        <section
      ...
      {isSectionVisible("journal.other.cta") && backLinkTarget ? (
